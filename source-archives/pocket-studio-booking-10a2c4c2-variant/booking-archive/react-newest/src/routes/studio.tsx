...
export const Route = createFileRoute("/studio")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Independent Seattle hair studio by MyKey Pocket. Cuts, color, and consults booked one month at a time." },
    ],
  }),
  component: Home,
});
...
function Policies() {
  const items = [
    ...
    ["House-call space", "The studio is a shared home space — plus-ones only when arranged."],
  ];
  return (
