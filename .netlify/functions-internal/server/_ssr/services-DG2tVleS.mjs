//#region node_modules/.nitro/vite/services/ssr/assets/services-DG2tVleS.js
...
var SERVICES = [
	{
		...
		images: [{
			src: "/work/buzz-1.jpg",
			alt: "Fresh fade with clean edges"
		}]
	},
	{
		slug: "taper-fade-cut",
		...
		images: [
			{
				...
				alt: "Short textured cut, side view"
			},
			{
				src: "/work/short-2.jpg",
				alt: "Precision short shape"
			},
			{
				src: "/work/short-3.jpg",
				alt: "Curly short cut, natural light"
			}
		]
	},
	{
		...
		images: [{
			src: "/work/long-1.jpg",
			alt: "Long layered cut, shoulder length"
		}, {
			src: "/work/long-2.jpg",
			alt: "Layered shape with movement"
		}]
	},
	{
		slug: "curl-cut",
		...
		detail: "Your curls cut the way they actually spring — dry, curl by curl, no surprises after the first wash.",
		goodFor: "Waves, curls, and coils that need shape — from loose 2s to tight 4s, first curl cuts and rescues.",
		whatHappens: [
	...
	},
	{
		...
		images: [{
			src: "/work/consult-1.jpg",
			alt: "Vivid green undercut color result"
		}, {
			src: "/work/consult-2.jpg",
			alt: "Peekaboo color placement"
		}]
	},
	{
		...
		images: [
			{
				src: "/work/color-1.jpg",
				alt: "Dimensional color with vivid peekaboo"
			},
			{
				src: "/work/color-2.jpg",
				alt: "Fresh color result, three-quarter view"
			},
			{
				src: "/work/color-3.jpg",
				alt: "Color placement detail"
			}
		]
	}
];
//#endregion
export { SERVICES as n, CAL_BASE as t };
